...
@section('main')
	<div class="custom-section-svg">
		...
		version="1.1"
		style="background-image: url(/images/bg-full.jpg); background-size: cover; background-position: center;">
			...
			<div class="row">
				<div class="col-xl-7 pb-5 pb-xl-0 mb-5 mb-xl-0">
					<div class="custom-overlapping-cards">
						...
						<img src="/images/puzzle-and-dots.png" class="custom-overlapping-cards-puzzle-background" alt="Puzzle and Dots background image" />
					</div>
				</div>
				<div class="col-xl-5">
	...
	<section class="section custom-bg-color-grey-1 border-0 pb-0 m-0 mb-4">
		<div class="container container-xl-custom">
			<div class="row">
